...
public class UserDAO implements IUserDao{
	...
	public User findById(java.lang.Integer id) {
		...
		try {
			User instance = (User) hibernateTemplate.get(
					"com.zjj.model.User", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List<User> findAll() {
		...
		System.out.println("finding all User instances");
		try {
	...
	public User merge(User detachedInstance) {
		...
		try {
			User result = (User) hibernateTemplate.merge(detachedInstance);
